...
function PlaygroundWindowContent({
  ...
  return (
    <div
      ...
      className="playground-window bg-background @container flex h-full min-w-0 flex-col rounded-lg border shadow-sm"
    >
      {/* Window Header */}
      <div className="bg-muted/50 relative flex-shrink-0 border-b px-3 py-1">
